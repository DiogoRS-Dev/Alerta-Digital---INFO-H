...
class Usuários(models.Model):
    ...
    email = models.DecimalField(max_digits=8, decimal_places=2, verbose_name="Valor energético (Cal)") # --------------------- ()
    idade = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Açúcares totais (100g)")
    carboidratoss = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Carboidratos (100g)")
    proteinas = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Proteínas (100g)")
    gorduras_totais = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Gorduras totais (100g)") 
    fibras = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Fibras (100g)")
    sodio = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Sódio (100g)")
...
class Questionario(models.Model):
    ...
    raça = models.CharField(max_length=100, verbose_name="Raça do animal")
    porte = models.CharField(max_length=100, verbose_name="Porte do animal")
    peso = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Peso do animal")
    idade = models.IntegerField(verbose_name="idade do animal (anos)")
    possui_doenca = models.CharField(max_length=100, blank=True, null=True, verbose_name="O animal possui alguma doença? Caso não tenha, mantenha o campo em branco")
    alergia = models.CharField(max_length=100, blank=True, null=True, verbose_name="O animal possui alguma alergia? Caso não tenha, mantenha o campo em branco")
...
class Artigo(models.Model):
    nome = models.CharField(max_length=1000, verbose_name="Nome do Artigo")
    autor = models.CharField(max_length=100, verbose_name="Autor")
    ano = models.IntegerField(verbose_name="Ano de Publicação")
    link = models.CharField(max_length=10000, verbose_name="Link do artigo")
